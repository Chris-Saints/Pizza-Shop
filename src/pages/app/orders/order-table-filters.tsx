...
export function OrderTableFilters() {
    ...
    return(
        <form onSubmit={handleSubmit(handleFilter)} className="flex items-center gap-2">
            <span className="text-sm fonr-semibold">Filtros:</span>
            <Input placeholder="ID do pedido" className=" p-2 h-8 w-auto" {...register('orderId')} />

            <Input placeholder="Nome do cliente" className=" p-2 h-8 w-[320px]" {...register('customerName')}/>
